from cursos.models import Curso, Categoria, Clase
...
if not creador:
    print("Error: No users found in database to assign as creator.")
    exit()
...
curso, creado = Curso.objects.get_or_create(
    titulo="Cuidado Integral del Adulto Mayor: Salud, Bienestar y Trato Digno",
    defaults={
...
if not creado:
    # Evitar duplicar
    print("El curso ya existe en la base de datos.")
else:
    # Clases
    clases_data = [
        {
            "titulo": "Módulo 1 - Clase 1: Psicología del Envejecimiento y Trato Digno",
        ...
        {
            "titulo": "Módulo 1 - Clase 2: Fomento de la Autonomía vs Asistencialismo",
        ...
        {
            "titulo": "Módulo 2 - Clase 3: Movilidad y Prevención de Caídas",
        ...
        {
            "titulo": "Módulo 2 - Clase 4: Alimentación e Higiene Personal",
        ...
        {
            "titulo": "Módulo 3 - Clase 5: Salud Mental, Alzheimer y Demencia",
    ...
    evaluacion = Evaluacion.objects.create(
        curso=curso,
        titulo="Evaluación Intermedia: Conocimientos Básicos de Cuidado",
        porcentaje_aprobacion=70,
        max_intentos=0,
        orden=3
    )
    Pregunta.objects.create(
        evaluacion=evaluacion, banco=banco,
        texto="1. Al tratar con un adulto mayor que está experimentando pérdida de autonomía, la mejor actitud del cuidador es: a) Hacer absolutamente todo por él. b) Escuchar activamente sus frustraciones y fomentar que haga lo que aún puede hacer. c) Tratarlo como a un niño. d) Ignorar sus quejas."
    )
    Pregunta.objects.create(
        evaluacion=evaluacion, banco=banco,
        texto="2. ¿Cuál de las siguientes es una medida clave para prevenir caídas en el hogar? a) Usar calcetines gruesos en lugar de zapatos. b) Instalar alfombras pequeñas decorativas. c) Mantener iluminación adecuada e instalar barras de sujeción en el baño. d) Pedirle que nunca se levante."
    )
    Pregunta.objects.create(
        evaluacion=evaluacion, banco=banco,
        texto="3. Para prevenir las úlceras por presión (escaras) en un paciente postrado, es fundamental: a) Bañarlo con agua muy caliente. b) Realizar cambios posturales cada 2 o 3 horas. c) Frotar la piel fuertemente al secarlo. d) Dejarlo en la misma posición toda la noche."
    )
    ...
    print(f"Curso '{curso.titulo}' subido a la base de datos exitosamente con sus 5 clases, cuestionario y tarea.")
